...
foreach mass ( 2500 3800 )
   ...
   echo 'Done!'
   echo "Dumping /WprimeToTB_plusSM_TToLep_M-${mass}_LH_TuneCUETP8M1_13TeV-comphep-pythia8/RunIISpring16MiniAODv2-PUSpring16RAWAODSIM_80X_mcRun2_asymptotic_2016_miniAODv2_v0-v1/MINIAODSIM:"
   if ($mass == 2500) then
     eval das_client --query=\"file dataset=/WprimeToTB_plusSM_TToLep_M-2500_LH_TuneCUETP8M1_13TeV-comphep-pythia8/RunIISpring16MiniAODv2-PUSpring16RAWAODSIM_reHLT_80X_mcRun2_asymptotic_v14-v1/MINIAODSIM\" --format=plain --limit=0 > python/Samples_2016/WprimeToTB_plusSM_TToLep_M_${mass}_LH_TuneCUETP8M1_13TeV_comphep_pythia8_RunIISpring16MiniAODv2_PUSpring16RAWAODSIM_80X_mcRun2_asymptotic_2016_miniAODv2_v0_v1_cff.txt 
     eval das_client --query=\"file dataset=/WprimeToTB_plusSM_TToLep_M-2500_LH_13TeV-comphep/RunIISpring16MiniAODv2-PUSpring16RAWAODSIM_reHLT_80X_mcRun2_asymptotic_v14_ext1-v2/MINIAODSIM\" --format=plain --limit=0 >> python/Samples_2016/WprimeToTB_plusSM_TToLep_M_${mass}_LH_TuneCUETP8M1_13TeV_comphep_pythia8_RunIISpring16MiniAODv2_PUSpring16RAWAODSIM_80X_mcRun2_asymptotic_2016_miniAODv2_v0_v1_cff.txt 
   else if ($mass == 3800) then
     eval das_client --query=\"file dataset=/WprimeToTB_plusSM_TToLep_M-3800_LH_TuneCUETP8M1_13TeV-comphep-pythia8/RunIISpring16MiniAODv2-PUSpring16RAWAODSIM_reHLT_80X_mcRun2_asymptotic_v14-v1/MINIAODSIM\" --format=plain --limit=0 > python/Samples_2016/WprimeToTB_plusSM_TToLep_M_${mass}_LH_TuneCUETP8M1_13TeV_comphep_pythia8_RunIISpring16MiniAODv2_PUSpring16RAWAODSIM_80X_mcRun2_asymptotic_2016_miniAODv2_v0_v1_cff.txt 
     eval das_client --query=\"file dataset=/WprimeToTB_plusSM_TToLep_M-3800_LH_13TeV-comphep/RunIISpring16MiniAODv2-PUSpring16RAWAODSIM_reHLT_80X_mcRun2_asymptotic_v14_ext1-v1/MINIAODSIM\" --format=plain --limit=0 >> python/Samples_2016/WprimeToTB_plusSM_TToLep_M_${mass}_LH_TuneCUETP8M1_13TeV_comphep_pythia8_RunIISpring16MiniAODv2_PUSpring16RAWAODSIM_80X_mcRun2_asymptotic_2016_miniAODv2_v0_v1_cff.txt 
   else
     eval das_client --query=\"file dataset=/WprimeToTB_plusSM_TToLep_M-${mass}_LH_TuneCUETP8M1_13TeV-comphep-pythia8/RunIISpring16MiniAODv2-PUSpring16RAWAODSIM_80X_mcRun2_asymptotic_2016_miniAODv2_v0-v1/MINIAODSIM\" --format=plain --limit=0 > python/Samples_2016/WprimeToTB_plusSM_TToLep_M_${mass}_LH_TuneCUETP8M1_13TeV_comphep_pythia8_RunIISpring16MiniAODv2_PUSpring16RAWAODSIM_80X_mcRun2_asymptotic_2016_miniAODv2_v0_v1_cff.txt 
     eval das_client --query=\"file dataset=/WprimeToTB_plusSM_TToLep_M-${mass}_LH_13TeV-comphep/RunIISpring16MiniAODv2-PUSpring16RAWAODSIM_80X_mcRun2_asymptotic_2016_miniAODv2_v0_ext1-v1/MINIAODSIM\" --format=plain --limit=0 >> python/Samples_2016/WprimeToTB_plusSM_TToLep_M_${mass}_LH_TuneCUETP8M1_13TeV_comphep_pythia8_RunIISpring16MiniAODv2_PUSpring16RAWAODSIM_80X_mcRun2_asymptotic_2016_miniAODv2_v0_v1_cff.txt 
   endif
   echo 'Done!'
   set vers = 1
   if ($mass == 1700 || $mass == 1900 || $mass == 3000 || $mass == 3100) then
     set vers = 2
     echo 'Got it'
   endif
   echo "Dumping /WprimeToTB_plusSM_TToLep_M-${mass}_mixed_sqrt_TuneCUETP8M1_13TeV-comphep-pythia8/RunIISpring16MiniAODv2-PUSpring16RAWAODSIM_80X_mcRun2_asymptotic_2016_miniAODv2_v0-v1/MINIAODSIM:"
   #eval das_client --query=\"file dataset=/WprimeToTB_plusSM_TToLep_M-${mass}_mixed_sqrt_13TeV-comphep/RunIISpring16MiniAODv2-PUSpring16RAWAODSIM_reHLT_80X_mcRun2_asymptotic_v14-v1/MINIAODSIM\" --format=plain --limit=0 > python/Samples_2016/WprimeToTB_plusSM_TToLep_M_${mass}_mixed_sqrt_TuneCUETP8M1_13TeV_comphep_pythia8_RunIISpring16MiniAODv2_PUSpring16RAWAODSIM_80X_mcRun2_asymptotic_2016_miniAODv2_v0_v1_cff.txt 
   #eval das_client --query=\"file dataset=/WprimeToTB_plusSM_TToLep_M-${mass}_mixed_sqrt_13TeV-comphep/RunIISpring16MiniAODv2-PUSpring16RAWAODSIM_reHLT_80X_mcRun2_asymptotic_v14_ext1-v${vers}/MINIAODSIM\" --format=plain --limit=0 >> python/Samples_2016/WprimeToTB_plusSM_TToLep_M_${mass}_mixed_sqrt_TuneCUETP8M1_13TeV_comphep_pythia8_RunIISpring16MiniAODv2_PUSpring16RAWAODSIM_80X_mcRun2_asymptotic_2016_miniAODv2_v0_v1_cff.txt 
end
