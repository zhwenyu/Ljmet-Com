...
# with command line options: Configuration/GenProduction/python/EightTeV/Hadronizer_TuneZ2_8TeV_generic_LHE_pythia_cff.py --filein=file:events_fixed.lhe --step GEN,FASTSIM,HLT --conditions auto:startup --pileup 2012_Startup_inTimeOnly --datamix NODATAMIXER --eventcontent AODSIM --datatier AODSIM --python_filename=LHE_to_FastSim_8Tev_AODSIM.py --fileout=fastsim_aodsim.root -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/reps/CMSSW/UserCode/LJMet/Com/python/LHE_to_FastSim_8Tev_AODSIM.py,v $')
)
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('fastsim_aodsim.root'),
