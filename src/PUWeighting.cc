...
PUWeighting::PUWeighting(const TH1D * thehistData, const TH1F * thehistMC, bool useoot){
...
void PUWeighting::setPUHisto(const TH1D * thehistData){
...
void PUWeighting::setPUHisto(const TH1D * thehistData, const TH1F * thehistMC){
  ...
  puHisto_Data->Scale(1.0/ puHisto_Data->Integral());
  weights_ = new TH1F("weights_", "weights_", 31,-0.5,30.5);
  weights_->Divide(thehistData, puHisto_MC, 1, 1, "b");
...
vector<double> PUWeighting::reweight2011_inputOnly(const TH1D* data_npu_estimated){
  ...
  /*
  const double npu_probs[25] = {  0.104109,
				  0.0703573,
				  0.0698445,
				  0.0698254,
				  0.0697054,
