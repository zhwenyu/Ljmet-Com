...
# 
# 	'/TTTT_TuneCP5_13TeV-amcatnlo-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM',
# 	
...
for sample in samplelist:
    ...
    #os.system('/cvmfs/cms.cern.ch/common/dasgoclient --limit=0 --query="file dataset = '+sample+'" &>> fileLists_Nov2-2018/'+sample.split('/')[1]+'_part1.txt')
    #os.system('/cvmfs/cms.cern.ch/common/dasgoclient --limit=0 --query="file dataset = '+sample+'" &>> fileLists_Nov2-2018/'+sample.split('/')[1]+'_part2.txt')
