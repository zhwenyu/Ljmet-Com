...
# dirpre = 'LJMet80x_TT_SSdilepton_2017_8_23_rizki/'

# dirpre = 'LJMet80x_TT_SSdilepton_TpTpCalcOn_2017_9_1_rizki/'
# dirpre = 'LJMet80x_TT_SSdilepton_TpTpCalcOn_2017_9_1_rizki/JECUP/JECUP/'
dirpre = 'LJMet80x_TT_SSdilepton_TpTpCalcOn_2017_9_1_rizki/JECDOWN/JECDOWN/'
# dirpre = 'LJMet80x_TT_SSdilepton_TpTpCalcOn_2017_9_1_rizki/JERUP/JERUP/'
# dirpre = 'LJMet80x_TT_SSdilepton_TpTpCalcOn_2017_9_1_rizki/JERDOWN/JERDOWN/'

print 'Checking folder '+dirpre
...
####################################################
# Resubmission - added by Rizki 21 Aug 2017
####################################################
for jobs in badfilelist:
	jobsdir = jobs.replace('_'+jobs.split('_')[-1],'')
	os.system('rm -v '+dirpre+jobsdir+'/'+jobs+'condor.log')
	os.system('rm -v '+dirpre+jobsdir+'/'+jobs+'stderr')
	os.system('rm -v '+dirpre+jobsdir+'/'+jobs+'stdout')
	os.system('condor_submit '+dirpre+jobsdir+'/'+jobs+'condor')