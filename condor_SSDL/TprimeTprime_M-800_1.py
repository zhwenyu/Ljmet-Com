...
process.inputs = cms.PSet (
   ...
   lumisToProcess = CfgTypes.untracked(CfgTypes.VLuminosityBlockRange()),
       fileNames  = cms.vstring(
	                 'root://cmsxrootd.fnal.gov//store/mc/RunIISummer16MiniAODv2/TprimeTprime_M-800_TuneCUETP8M1_13TeV-madgraph-pythia8/MINIAODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/50000/00453F68-BFD4-E611-A6B9-0025907DE2A0.root',
...
process.outputs = cms.PSet (
    #outputName = cms.string(scratchDir+'/TprimeTprime_M-800_1'),
    outputName = cms.string('TprimeTprime_M-800_1'),
