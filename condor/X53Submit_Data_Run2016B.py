...
### JSON file to use
MYJSON = "'../data/json/Cert_271036-280385_13TeV_PromptReco_Collisions16_JSON.txt'"
...
for i in range(len(prefix)):
    ...
    while ( nfiles <= count ):    
        ...
        py_templ_file = open(rel_base+"/src/LJMet/Com/condor/Dilepton_Data_Run2016B_python.templ")
