...
outdir = '/eos/uscms/store/user/lpctlbsm/clint/Run2015B/FakeRateTrees/'
...
for i in range(len(prefix)):
    ...
    while ( nfiles <= count ):    
        ...
        py_templ_file = open(rel_base+"/src/LJMet/Com/condor/Dilepton_Data_FakeRate_Run2015B_python.templ")
