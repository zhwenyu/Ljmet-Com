#ifndef HITFITINFOBRANCHES_H
#define HITFITINFOBRANCHES_H

#include <TTree.h>

static const unsigned int kMIN_HITFIT_JET=4;
static const unsigned int kMAX_HITFIT_JET=5;
...
class HitFitInfoBranches {
 public:
    ...
    Bool_t      unfittedJetIsBTaggedTCHEl      [kMAX_HITFIT*kMAX_HITFIT_JET];
    Bool_t      unfittedJetIsBTaggedTCHEm      [kMAX_HITFIT*kMAX_HITFIT_JET];
    Bool_t      unfittedJetIsBTaggedTCHEt      [kMAX_HITFIT*kMAX_HITFIT_JET];
    Bool_t      unfittedJetIsBTaggedTCHPl      [kMAX_HITFIT*kMAX_HITFIT_JET];
Bool_t      unfittedJetIsBTaggedTCHPm      [kMAX_HITFIT*kMAX_HITFIT_JET];
Bool_t      unfittedJetIsBTaggedTCHPt      [kMAX_HITFIT*kMAX_HITFIT_JET];
Bool_t      unfittedJetIsBTaggedJPl      [kMAX_HITFIT*kMAX_HITFIT_JET];
Bool_t      unfittedJetIsBTaggedJPm      [kMAX_HITFIT*kMAX_HITFIT_JET];
Bool_t      unfittedJetIsBTaggedJPt      [kMAX_HITFIT*kMAX_HITFIT_JET];
Bool_t      unfittedJetIsBTaggedSSVHEm      [kMAX_HITFIT*kMAX_HITFIT_JET];
Bool_t      unfittedJetIsBTaggedSSVHEt      [kMAX_HITFIT*kMAX_HITFIT_JET];
Bool_t      unfittedJetIsBTaggedSSVHPt      [kMAX_HITFIT*kMAX_HITFIT_JET];

 Double_t      unfittedJetIsBTaggedTCHE [kMAX_HITFIT*kMAX_HITFIT_JET];
 Double_t      unfittedJetIsBTaggedTCHP [kMAX_HITFIT*kMAX_HITFIT_JET];
 Double_t      unfittedJetIsBTaggedJP [kMAX_HITFIT*kMAX_HITFIT_JET];
 Double_t      unfittedJetIsBTaggedSSVHE [kMAX_HITFIT*kMAX_HITFIT_JET];
 Double_t      unfittedJetIsBTaggedSSVHP [kMAX_HITFIT*kMAX_HITFIT_JET];
   ...
   // real solution    : false=smaller solution, true=larger solution
    ...
    Bool_t      hitfitJetIsBTaggedTCHEl[kMAX_HITFIT*kMAX_HITFIT_JET];
    Bool_t      hitfitJetIsBTaggedTCHEm[kMAX_HITFIT*kMAX_HITFIT_JET];
    Bool_t      hitfitJetIsBTaggedTCHEt[kMAX_HITFIT*kMAX_HITFIT_JET];
    Bool_t      hitfitJetIsBTaggedTCHPl[kMAX_HITFIT*kMAX_HITFIT_JET];
    Bool_t      hitfitJetIsBTaggedTCHPm[kMAX_HITFIT*kMAX_HITFIT_JET];
    Bool_t      hitfitJetIsBTaggedTCHPt[kMAX_HITFIT*kMAX_HITFIT_JET];
    Bool_t      hitfitJetIsBTaggedJPl[kMAX_HITFIT*kMAX_HITFIT_JET]; 
    Bool_t      hitfitJetIsBTaggedJPm[kMAX_HITFIT*kMAX_HITFIT_JET];
    Bool_t      hitfitJetIsBTaggedJPt[kMAX_HITFIT*kMAX_HITFIT_JET];
    Bool_t      hitfitJetIsBTaggedSSVHEm[kMAX_HITFIT*kMAX_HITFIT_JET];
    Bool_t      hitfitJetIsBTaggedSSVHEt[kMAX_HITFIT*kMAX_HITFIT_JET];
    Bool_t      hitfitJetIsBTaggedSSVHPt[kMAX_HITFIT*kMAX_HITFIT_JET];
    // Bool_t      hitfitJetIsBTagged                  [kMAX_HITFIT*kMAX_HITFIT_JET];
    Double_t    hitfitJetIsBTaggedTCHE[kMAX_HITFIT*kMAX_HITFIT_JET];
    Double_t    hitfitJetIsBTaggedTCHP[kMAX_HITFIT*kMAX_HITFIT_JET];
    Double_t    hitfitJetIsBTaggedJP[kMAX_HITFIT*kMAX_HITFIT_JET];
    Double_t    hitfitJetIsBTaggedSSVHE[kMAX_HITFIT*kMAX_HITFIT_JET];
    Double_t    hitfitJetIsBTaggedSSVHP[kMAX_HITFIT*kMAX_HITFIT_JET];
    ...
    void RegisterTree(TTree *root) {
      ...
      root->Branch("HitFitInfo.unfittedJetIsBTaggedTCHE", &unfittedJetIsBTaggedTCHE[0]	, "HitFitInfo.unfittedJetIsBTaggedTCHE[HitFitInfo.nHitFitXnHitFitJet]/D"	);
      root->Branch("HitFitInfo.unfittedJetIsBTaggedTCHP", &unfittedJetIsBTaggedTCHP[0]	, "HitFitInfo.unfittedJetIsBTaggedTCHP[HitFitInfo.nHitFitXnHitFitJet]/D"	);
      root->Branch("HitFitInfo.unfittedJetIsBTaggedJP", &unfittedJetIsBTaggedJP[0]	, "HitFitInfo.unfittedJetIsBTaggedJP[HitFitInfo.nHitFitXnHitFitJet]/D"	);
      root->Branch("HitFitInfo.unfittedJetIsBTaggedSSVHE", &unfittedJetIsBTaggedSSVHE[0]	, "HitFitInfo.unfittedJetIsBTaggedSSVHE[HitFitInfo.nHitFitXnHitFitJet]/D"	);
      root->Branch("HitFitInfo.unfittedJetIsBTaggedSSVHP", &unfittedJetIsBTaggedSSVHP[0]	, "HitFitInfo.unfittedJetIsBTaggedSSVHP[HitFitInfo.nHitFitXnHitFitJet]/D"	);

      root->Branch("HitFitInfo.unfittedJetIsBTaggedTCHEl", &unfittedJetIsBTaggedTCHEl[0]	, "HitFitInfo.unfittedJetIsBTaggedTCHEl[HitFitInfo.nHitFitXnHitFitJet]/O"	);
     root->Branch("HitFitInfo.unfittedJetIsBTaggedTCHEm", &unfittedJetIsBTaggedTCHEm[0]	, "HitFitInfo.unfittedJetIsBTaggedTCHEm[HitFitInfo.nHitFitXnHitFitJet]/O"	);
     root->Branch("HitFitInfo.unfittedJetIsBTaggedTCHEt", &unfittedJetIsBTaggedTCHEt[0]	, "HitFitInfo.unfittedJetIsBTaggedTCHEt[HitFitInfo.nHitFitXnHitFitJet]/O"	);
     root->Branch("HitFitInfo.unfittedJetIsBTaggedTCHPl", &unfittedJetIsBTaggedTCHPl[0]	, "HitFitInfo.unfittedJetIsBTaggedTCHPl[HitFitInfo.nHitFitXnHitFitJet]/O"	);
     root->Branch("HitFitInfo.unfittedJetIsBTaggedTCHPm", &unfittedJetIsBTaggedTCHPm[0]	, "HitFitInfo.unfittedJetIsBTaggedTCHPm[HitFitInfo.nHitFitXnHitFitJet]/O"	);
     root->Branch("HitFitInfo.unfittedJetIsBTaggedTCHPt", &unfittedJetIsBTaggedTCHPt[0]	, "HitFitInfo.unfittedJetIsBTaggedTCHPt[HitFitInfo.nHitFitXnHitFitJet]/O"	);
     root->Branch("HitFitInfo.unfittedJetIsBTaggedJPl", &unfittedJetIsBTaggedJPl[0]	, "HitFitInfo.unfittedJetIsBTaggedJPl[HitFitInfo.nHitFitXnHitFitJet]/O"	);
     root->Branch("HitFitInfo.unfittedJetIsBTaggedJPm", &unfittedJetIsBTaggedJPm[0]	, "HitFitInfo.unfittedJetIsBTaggedJPm[HitFitInfo.nHitFitXnHitFitJet]/O"	);
     root->Branch("HitFitInfo.unfittedJetIsBTaggedJPt", &unfittedJetIsBTaggedJPt[0]	, "HitFitInfo.unfittedJetIsBTaggedJPt[HitFitInfo.nHitFitXnHitFitJet]/O"	);
     root->Branch("HitFitInfo.unfittedJetIsBTaggedSSVHEm", &unfittedJetIsBTaggedSSVHEm[0]	, "HitFitInfo.unfittedJetIsBTaggedSSVHEm[HitFitInfo.nHitFitXnHitFitJet]/O"	);
     root->Branch("HitFitInfo.unfittedJetIsBTaggedSSVHEt", &unfittedJetIsBTaggedSSVHEt[0]	, "HitFitInfo.unfittedJetIsBTaggedSSVHEt[HitFitInfo.nHitFitXnHitFitJet]/O"	);
     root->Branch("HitFitInfo.unfittedJetIsBTaggedSSVHPt", &unfittedJetIsBTaggedSSVHPt[0]	, "HitFitInfo.unfittedJetIsBTaggedSSVHPt[HitFitInfo.nHitFitXnHitFitJet]/O"	);
    ...
    void Register(TTree *root) {
      ...
      root->SetBranchAddress("HitFitInfo.unfittedJetIsBTaggedTCHE", &unfittedJetIsBTaggedTCHE[0]	);
      root->SetBranchAddress("HitFitInfo.unfittedJetIsBTaggedTCHP", &unfittedJetIsBTaggedTCHP[0]	);
      root->SetBranchAddress("HitFitInfo.unfittedJetIsBTaggedJP", &unfittedJetIsBTaggedJP[0]	);
      root->SetBranchAddress("HitFitInfo.unfittedJetIsBTaggedSSVHE", &unfittedJetIsBTaggedSSVHE[0]		);
      root->SetBranchAddress("HitFitInfo.unfittedJetIsBTaggedSSVHP", &unfittedJetIsBTaggedSSVHP[0]   	);
      


      
      root->SetBranchAddress("HitFitInfo.unfittedJetIsBTaggedTCHEl", &unfittedJetIsBTaggedTCHEl[0]);
      root->SetBranchAddress("HitFitInfo.unfittedJetIsBTaggedTCHEm", &unfittedJetIsBTaggedTCHEm[0]);
     root->SetBranchAddress("HitFitInfo.unfittedJetIsBTaggedTCHEt", &unfittedJetIsBTaggedTCHEt[0]);
     root->SetBranchAddress("HitFitInfo.unfittedJetIsBTaggedTCHPl", &unfittedJetIsBTaggedTCHPl[0]);
     root->SetBranchAddress("HitFitInfo.unfittedJetIsBTaggedTCHPm", &unfittedJetIsBTaggedTCHPm[0]	);
     root->SetBranchAddress("HitFitInfo.unfittedJetIsBTaggedTCHPt", &unfittedJetIsBTaggedTCHPt[0]	);
     root->SetBranchAddress("HitFitInfo.unfittedJetIsBTaggedJPl", &unfittedJetIsBTaggedJPl[0]	);
     root->SetBranchAddress("HitFitInfo.unfittedJetIsBTaggedJPm", &unfittedJetIsBTaggedJPm[0]	);
     root->SetBranchAddress("HitFitInfo.unfittedJetIsBTaggedJPt", &unfittedJetIsBTaggedJPt[0]);
     root->SetBranchAddress("HitFitInfo.unfittedJetIsBTaggedSSVHEm", &unfittedJetIsBTaggedSSVHEm[0]	);
     root->SetBranchAddress("HitFitInfo.unfittedJetIsBTaggedSSVHEt", &unfittedJetIsBTaggedSSVHEt[0]	);
     root->SetBranchAddress("HitFitInfo.unfittedJetIsBTaggedSSVHPt", &unfittedJetIsBTaggedSSVHPt[0]	);
	...
	unfittedJetIsBTaggedTCHE      [i] = 0.;
	unfittedJetIsBTaggedTCHP      [i] = 0.;
	unfittedJetIsBTaggedJP      [i] = 0.;
	unfittedJetIsBTaggedSSVHE      [i] = 0.;
	unfittedJetIsBTaggedSSVHP      [i] = 0.;


	unfittedJetIsBTaggedTCHEl      [i] = false;
	unfittedJetIsBTaggedTCHEm      [i] = false;
	unfittedJetIsBTaggedTCHEt      [i] = false;
	unfittedJetIsBTaggedTCHPl      [i] = false;
	unfittedJetIsBTaggedTCHPm      [i] = false;
	unfittedJetIsBTaggedTCHPt      [i] = false;
	unfittedJetIsBTaggedJPl      [i] = false;
	unfittedJetIsBTaggedJPm      [i] = false;
	unfittedJetIsBTaggedJPt      [i] = false;
	unfittedJetIsBTaggedSSVHEm      [i] = false;
	unfittedJetIsBTaggedSSVHEt      [i] = false;
	unfittedJetIsBTaggedSSVHPt      [i] = false;

	unfittedJetPResInverse    [i] = false;
	//hitfitJetIsBTagged        [i] = false;//ml
