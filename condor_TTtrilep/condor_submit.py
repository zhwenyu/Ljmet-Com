#!/usr/bin/python
execfile("/uscms_data/d3/rsyarif/FermilabFall2016/produceLJMetNtuple2016/CMSSW_8_0_17/src/LJMet/Com/condor_TTtrilep/EOSSafeUtils.py")
...
tempdir = '/uscms_data/d3/rsyarif/FermilabFall2016/produceLJMetNtuple2016/'+outputdir.split('/')[-1]+'_logs/'+shift+'/'+prefix
os.makedirs(tempdir)
...
while ( nfiles <= count ):
    ...
    jdl_templ_file = open(relBase+'/src/LJMet/Com/condor_TTSingleLep/template.jdl')
