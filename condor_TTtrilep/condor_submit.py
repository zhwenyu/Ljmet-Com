#!/usr/bin/python
execfile("/uscms_data/d3/rsyarif/FermilabFall2016/produceLJMetNtuple2016_FullDataset_v2/CMSSW_8_0_20/src/LJMet/Com/condor_TTtrilep/EOSSafeUtils.py")
...
tempdir = '/uscms_data/d3/rsyarif/FermilabFall2016/produceLJMetNtuple2016_FullDataset_v2/'+outputdir.split('/')[-1]+'_logs/'+shift+'/'+prefix
os.makedirs(tempdir)
