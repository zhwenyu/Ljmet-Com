...
thisDir = relBase+'/src/LJMet/Com/condor_TTSingleLep/' 
tarfile = relBase+'.tar'
print 'Making tar:'
...
for sample in sampleList:
	os.system('python condor_submit.py --useMC True --sample '+sample.split('.')[0]+' --fileList '+thisDir+'fileListsSpring16/'+sample+' --submit True --inputTar '+tarfile+' --outDir /eos/uscms/store/user/lpcljm/2016/LJMet_1lepTT_080116 --shift '+shift)
