...
sampleList=[
	...
	#### ttbar
	# 'TT_TuneCUETP8M2T4_backup_13TeV-powheg-pythia8.txt',
	...
	#'WJetsToLNu_HT-400To600_TuneCUETP8M1_v1_13TeV-madgraphMLM-pythia8.txt',
...
notcernlist = [
	...
	#'WJetsToLNu_HT-400To600_TuneCUETP8M1_ext1_13TeV-madgraphMLM-pythia8.txt',
	#'TT_TuneCUETP8M2T4_v1_13TeV-powheg-pythia8.txt',
	'WJetsToLNu_TuneCUETP8M1_ext_13TeV-madgraphMLM-pythia8.txt',
]
...
if os.path.exists(tarfile):
	...
	print 'tar --exclude="src/LJMet/Com/.git" --exclude="src/.git" --exclude="src/LJMetSlimmer" --exclude="src/PhysicsTools" --exclude="src/EgammaAnalysis" --exclude="src/TopQuarkAnalysis" --exclude="tmp" -zcf'+tarfile+' '+relBase.split('/')[-1]+'/'
	os.system('tar --exclude="src/LJMet/Com/.git" --exclude="src/.git" --exclude="src/LJMetSlimmer" --exclude="src/PhysicsTools" --exclude="src/EgammaAnalysis" --exclude="src/TopQuarkAnalysis" --exclude="tmp" -zcf '+tarfile+' '+relBase.split('/')[-1])
	os.chdir(thisDir)
...
for sample in sampleList:
	...
	GenHT = True
	os.system('python condor_submit.py --useMC True --sample '+sample.split('.')[0]+' --fileList '+thisDir+'fileListsMoriond17/'+sample+' --submit True --inputTar '+tarfile+' --outDir /eos/uscms/store/user/lpcljm/2016/LJMet80X_1lep_041917 --shift '+shift+' --saveGenHT '+str(GenHT)+' --accessor '+accessor)
