...
process.JetSubCalc.MCL2JetParAK8 = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016V2_MC_L2Relative_AK8PFchs.txt')
process.JetSubCalc.MCL3JetParAK8 = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016V2_MC_L3Absolute_AK8PFchs.txt')
process.JetSubCalc.MCPTResAK8 = cms.string(relBase+'/src/LJMet/Com/data/Spring16V6/Spring16_25nsV6_MC_PtResolution_AK8PFchs.txt')
process.JetSubCalc.MCSF = cms.string(relBase+'/src/LJMet/Com/data/Spring16V6/Spring16_25nsV6_MC_SF_AK4PFchs.txt')
process.JetSubCalc.DataL2JetParAK8 = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016BCDV2_DATA_L2Relative_AK8PFchs.txt')
process.JetSubCalc.DataL3JetParAK8 = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016BCDV2_DATA_L3Absolute_AK8PFchs.txt')
process.JetSubCalc.DataL2L3JetParAK8 = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016BCDV2_DATA_L2L3Residual_AK8PFchs.txt')
process.JetSubCalc.UncertaintyAK8 = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016V2_MC_Uncertainty_AK8PFchs.txt')
...
process.event_selector = cms.PSet(
    ...
    mctrigger_path_el = cms.vstring(
        ...
        'HLT_Ele45_CaloIdVT_GsfTrkIdT_PFJet200_PFJet50_v1', 'HLT_Ele45_CaloIdVT_GsfTrkIdT_PFJet200_PFJet50_v2',
        ...
        'HLT_PFHT600_v1', 'HLT_PFHT600_v2', 'HLT_PFHT600_v3', 'HLT_PFHT600_v4', 'HLT_PFHT600_v5', 'HLT_PFHT600_v6',
        'digitisation_step',
        'raw2digi_step',
        ),
    mctrigger_path_mu = cms.vstring(
        'HLT_IsoMu24_v1', 'HLT_IsoMu24_v2', 'HLT_IsoMu24_v3', 'HLT_IsoMu24_v4', 'HLT_IsoMu24_v5', 'HLT_IsoMu24_v6', 'HLT_IsoMu24_v7',
        'HLT_IsoTkMu24_v1', 'HLT_IsoTkMu24_v2', 'HLT_IsoTkMu24_v3', 'HLT_IsoTkMu24_v4',        
        'HLT_IsoTkMu24_v5', 'HLT_IsoTkMu24_v6', 'HLT_IsoTkMu24_v7',         
    ...
    JEC_txtfile = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016V2_MC_Uncertainty_AK4PFchs.txt'),
    JERSF_txtfile = cms.string(relBase+'/src/LJMet/Com/data/Spring16V6/Spring16_25nsV6_MC_SF_AK4PFchs.txt'),
    JER_txtfile = cms.string(relBase+'/src/LJMet/Com/data/Spring16V6/Spring16_25nsV6_MC_PtResolution_AK4PFchs.txt'),
    JERAK8_txtfile = cms.string(relBase+'/src/LJMet/Com/data/Spring16V6/Spring16_25nsV6_MC_PtResolution_AK8PFchs.txt'),
    ...
    MCL1JetPar               = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016V2_MC_L1FastJet_AK4PFchs.txt'),
    MCL2JetPar               = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016V2_MC_L2Relative_AK4PFchs.txt'),
    MCL3JetPar               = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016V2_MC_L3Absolute_AK4PFchs.txt'),

    MCL1JetParAK8            = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016V2_MC_L1FastJet_AK8PFchs.txt'),
    MCL2JetParAK8            = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016V2_MC_L2Relative_AK8PFchs.txt'),
    MCL3JetParAK8            = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016V2_MC_L3Absolute_AK8PFchs.txt'),

    DataL1JetPar             = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016BCDV2_DATA_L1FastJet_AK4PFchs.txt'),
    DataL2JetPar             = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016BCDV2_DATA_L2Relative_AK4PFchs.txt'),
    DataL3JetPar             = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016BCDV2_DATA_L3Absolute_AK4PFchs.txt'),
    DataResJetPar            = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016BCDV2_DATA_L2L3Residual_AK4PFchs.txt'),

    DataL1JetParAK8          = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016BCDV2_DATA_L1FastJet_AK8PFchs.txt'),
    DataL2JetParAK8          = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016BCDV2_DATA_L2Relative_AK8PFchs.txt'),
    DataL3JetParAK8          = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016BCDV2_DATA_L3Absolute_AK8PFchs.txt'),
    DataResJetParAK8         = cms.string(relBase+'/src/LJMet/Com/data/Spring16RR/Spring16_23Sep2016BCDV2_DATA_L2L3Residual_AK8PFchs.txt'),
