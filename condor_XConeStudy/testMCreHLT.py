...
process.inputs = cms.PSet (
    ...
    fileNames  = cms.vstring(
		...
		'TprimeTprime_M-800_TuneCUETP8M1_13TeV-madgraph-pythia8.root',
		#'TprimeTprime_M-1300_TuneCUETP8M1_13TeV-madgraph-pythia8.root',
		#'TprimeTprime_M-1800_TuneCUETP8M1_13TeV-madgraph-pythia8.root',
...
process.outputs = cms.PSet (
    outputName = cms.string('testmc_reHLT_XCone'),
