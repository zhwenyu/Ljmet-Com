#!/usr/bin/python
execfile("/uscms_data/d3/rsyarif/Fermilab2017/XConeinLJMet80x/CMSSW_8_0_25/src/LJMet/Com/condor_XConeStudy/EOSSafeUtils.py")
...
tempdir = '/uscms_data/d3/rsyarif/Fermilab2017/XConeinLJMet80x/'+outputdir.split('/')[-1]+'_logs/'+shift+'/'+prefix
os.makedirs(tempdir)
...
while ( nfiles <= count ):
    ...
    py_templ_file = open(relBase+'/src/LJMet/Com/condor_XConeStudy/ljmet_cfg.py')
...
#         line=line.replace('SAVEGENHT',  saveGHT)
    ...
    jdl_templ_file = open(relBase+'/src/LJMet/Com/condor_XConeStudy/template.jdl')
