...
#         if 'QCD' in folder: continue 
#         if 'DY' not in folder: continue 
#         if 'TT' not in folder: continue 
#         if 'combined' not in folder: continue 
	...
	for index in resub_index:
		...
		os.system('rm -v ' + dir + '/' + folder + '/' + folder.replace('/logfiles/','') + '_' + index + '.log')
		os.system('rm -v ' + dir + '/' + folder + '/' + folder.replace('/logfiles/','') + '_' + index + '.condor')
