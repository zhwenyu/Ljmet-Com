...
#     os.system('/cvmfs/cms.cern.ch/common/das_client --limit=0 --query="file dataset = '+sample+'" &>> fileListsMoriond17/'+sample.split('/')[1]+'.txt')
    os.system('/cvmfs/cms.cern.ch/common/das_client --limit=0 --query="file dataset = '+sample+'" &>> fileListsMoriond17_TEST/'+sample.split('/')[1]+'.txt')
...
#     print 'listing files in',sample
#     os.system('/cvmfs/cms.cern.ch/common/das_client --limit=0 --query="file dataset = '+sample+'" &>> fileLists_Mar21/'+sample.split('/')[1]+'_RRB.txt')
# 
# for sample in datalistRRC:
#     print 'listing files in',sample
#     os.system('/cvmfs/cms.cern.ch/common/das_client --limit=0 --query="file dataset = '+sample+'" &>> fileLists_Mar21/'+sample.split('/')[1]+'_RRC.txt')
# 
# for sample in datalistRRD:
#     print 'listing files in',sample
#     os.system('/cvmfs/cms.cern.ch/common/das_client --limit=0 --query="file dataset = '+sample+'" &>> fileLists_Mar21/'+sample.split('/')[1]+'_RRD.txt')
# 
# for sample in datalistRRE:
#     print 'listing files in',sample
#     os.system('/cvmfs/cms.cern.ch/common/das_client --limit=0 --query="file dataset = '+sample+'" &>> fileLists_Mar21/'+sample.split('/')[1]+'_RRE.txt')
# 
# for sample in datalistRRF:
#     print 'listing files in',sample
#     os.system('/cvmfs/cms.cern.ch/common/das_client --limit=0 --query="file dataset = '+sample+'" &>> fileLists_Mar21/'+sample.split('/')[1]+'_RRF.txt')
# 
# for sample in datalistRRG:
#     print 'listing files in',sample
#     os.system('/cvmfs/cms.cern.ch/common/das_client --limit=0 --query="file dataset = '+sample+'" &>> fileLists_Mar21/'+sample.split('/')[1]+'_RRG.txt')
# 
