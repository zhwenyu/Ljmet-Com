...
# 	if 'WJetsToLNu_TuneCUE' in folder : continue
# 	if 'ZZZ' not in folder : continue
# 	if 'Run2015' not in folder : continue
	#if folder != 'QCD_HT700to1000_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_25ns': continue
	#if 'ST_t' not in folder and 'ST_s' not in folder and 'TTW' not in folder and 'TTZ' not in folder: continue
