#!/usr/bin/python
execfile("/uscms_data/d3/rsyarif/Spring2016/produceLJMetNtuple76x/CMSSW_7_6_4/src/LJMet/Com/condor_TTinclusive_032516/EOSSafeUtils.py")
...
tempdir = '/uscms_data/d3/rsyarif/Spring2016/produceLJMetNtuple76x/'+outputdir.split('/')[-1]+'_logs/'+shift+'/'+prefix
os.makedirs(tempdir)
...
while ( nfiles <= count ):
    ...
    py_templ_file = open(relBase+'/src/LJMet/Com/condor_TTinclusive_032516/ljmet_cfg.py')
    ...
    jdl_templ_file = open(relBase+'/src/LJMet/Com/condor_TTinclusive_032516/template.jdl')
