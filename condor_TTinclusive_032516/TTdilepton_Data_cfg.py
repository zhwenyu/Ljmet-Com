...
process.event_selector = cms.PSet(
    ...
    jet_minpt                = cms.double(25.0),
    jet_maxeta               = cms.double(5.0),
    min_jet                  = cms.int32(0),
    max_jet                  = cms.int32(4000),
    leading_jet_pt           = cms.double(25.0),
    ...
    electron_CutsPlusMVA     = cms.bool(True),
    ...
    min_loose_lepton         = cms.int32(2),    # checks (N loose mu + N loose el) >= cut
    max_loose_lepton         = cms.int32(1000),  # checks (N loose mu + N loose el) <= cut
    ...
    max_met                  = cms.double(9999999999999.9),
...
process.load('LJMet.Com.TopElectronSelector_cfi') #not used
